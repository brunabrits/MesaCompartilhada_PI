...
CREATE TABLE ENDERECO_ED (
  Endereco_Ed varchar(80) PRIMARY KEY,
...
CREATE TABLE ENDERECO_ER(
  Endereco_Er varchar(80) PRIMARY KEY,
...
CREATE TABLE EMPRESA_DOADORA(
 Cod_Ed int not null PRIMARY KEY,
 Nome_Ed varchar(50),
 Cnpj_Ed char(14),
 Tipo_Ed varchar(20),
 Email_Ed varchar(30),
